...
ds = dataset('File','..\VRR_subjective_Quest\Result_Quest_duration_1\Observer_Yancheng_Cai_2/reorder_result.csv','Delimiter',',');
options = { 'psych_func', @pf_dec_lin, 'intensity_label', 'Color Value', 'intensity_scale', 'linear', ...
            ...
            'report_file',  '..\VRR_subjective_Quest\Result_Quest_duration_1\Observer_Yancheng_Cai_2/report/reorder_result_D_thr.html'};
D_thr = fit_psych_func( ds, { 'Duration','VRR_Frequency'}, 'Threshold_Color_Value', 'Response', 260, 0.5, options ); %260
D_thr_table = dataset2table(D_thr);
writetable(D_thr_table, '..\VRR_subjective_Quest\Result_Quest_duration_1\Observer_Yancheng_Cai_2/reorder_result_D_thr.csv', 'Delimiter', ',');