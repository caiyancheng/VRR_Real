...
def calibration_color_size(stimulus_params, color_change_parameters, random_shuffle, save_dir_path):
    ...
    for setting_index in range(len(setting_list)):
        ...
        print('Size', size_value, 'Color', color_value, 'Luminance', Y)
...
if __name__ == "__main__":
    ...
    save_dir_path = f'py_display_calibration_results_new/LG-G1-Std-{formatted_time}'
    os.makedirs(save_dir_path)
    config_json = {'stimulus_params': stimulus_params, 'color_change_parameters': color_change_parameters}
