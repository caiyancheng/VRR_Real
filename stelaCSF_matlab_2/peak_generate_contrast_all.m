function [L_thr, C_thr] = peak_generate_contrast_all(csf_model, t_frequency, area_value, radius, k_scale, fit_poly_degree, Luminance_lb, Luminance_ub, peak_spatial_frequency)
