...
suffixes = {'stelaCSF (Original Energy)', 'stelaCSF_{HF} (Original Energy)',  'BartenCSF (Original Energy)', 'BartenCSF_{HF} (Original Energy)', ...
            ...
            'stelaCSF (Spatial Intergration power 1)', 'stelaCSF_{HF} (Spatial Intergration power 1)',  'BartenCSF (Spatial Intergration power 1)', 'BartenCSF_{HF} (Spatial Intergration power 1)', ...
            'castleCSF (Spatial Intergration power 1)', 'stelaCSF transient (Spatial Intergration power 1)', 'stelaCSF_{HF} transient (Spatial Intergration power 1)', ...
            'stelaCSF (Spatial Intergration power 2)', 'stelaCSF_{HF} (Spatial Intergration power 2)',  'BartenCSF (Spatial Intergration power 2)', 'BartenCSF_{HF} (Spatial Intergration power 2)', ...
            'castleCSF (Spatial Intergration power 2)', 'stelaCSF transient (Spatial Intergration power 2)', 'stelaCSF_{HF} transient (Spatial Intergration power 2)', ...
            'stelaCSF (Spatial Intergration power 3)', 'stelaCSF_{HF} (Spatial Intergration power 3)',  'BartenCSF (Spatial Intergration power 3)', 'BartenCSF_{HF} (Spatial Intergration power 3)', ...
            'castleCSF (Spatial Intergration power 3)', 'stelaCSF transient (Spatial Intergration power 3)', 'stelaCSF_{HF} transient (Spatial Intergration power 3)'};
...
energy_model_spatial_with_pow1 = @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 1);
energy_model_spatial_with_pow2 = @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2);
energy_model_spatial_with_pow3 = @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3);
...
if optimize_need == 1
    ...
    initial_E_setting_luminance_value = 5;
...
if (optimize_need == 1)
    ...
    writematrix(optimized_E_thr_values, 'optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot.csv');
    writematrix(fvals, 'fvals_x_final_Quest_disk_C_t_energy_eachone_plot.csv');
else
    optimized_E_thr_values = readmatrix('optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot.csv');
end
...
if (csv_generate_vrr_f == 1)
    ...
    writematrix(C_thr_results_x_vrr_f_range, 'C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot.csv');
else
    C_thr_results_x_vrr_f_range_flat = readmatrix('C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot.csv');
