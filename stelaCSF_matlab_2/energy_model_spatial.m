function E = energy_model_spatial(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow)
    delta_rho = 0.01;
    num_rho_points = 5000;
    ...
    E = pi * sum((I_spatial.^pow) .* abs(yy)) * (size_deg / size(I_spatial, 1));
end
