...
for area_index = 1:length(area_contiuous)
    ...
    S_stelaCSF_all(area_index) = S_FF_generate(stelaCSF_model, luminance_value, area_value, vrr_f_value);
    S_stelaCSF_HF_all(area_index) = S_FF_generate(stelaCSF_HF_model, luminance_value, area_value, vrr_f_value);
    S_Barten_Original_all(area_index) = S_FF_generate(Barten_Original_model, luminance_value, area_value, vrr_f_value);
    S_Barten_HF_all(area_index) = S_FF_generate(Barten_HF_model, luminance_value, area_value, vrr_f_value);
    S_castleCSF_all(area_index) = S_FF_generate(castleCSF_model, luminance_value, area_value, vrr_f_value);
    S_stelaCSF_transient_all(area_index) = S_FF_generate(stelaCSF_transient_model, luminance_value, area_value, vrr_f_value);
    S_stelaCSF_HF_transient_all(area_index) = S_FF_generate(stelaCSF_HF_transient_model, luminance_value, area_value, vrr_f_value);
end
