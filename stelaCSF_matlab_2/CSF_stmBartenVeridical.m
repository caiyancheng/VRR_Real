classdef CSF_stmBartenVeridical < CSF_base

    % Modified spatiotemporal Barten CSF - as for HVEI 2024 paper


    methods

        function obj = CSF_stmBartenVeridical( )
            obj.par = obj.get_default_par();
        end

        function name = short_name( obj )
            % A short name that could be used as a part of a file name
            name = 'stmBarten-Veridical';
        end

        function name = full_name( obj )
            name = 'modified Barten''s spatiotemporal veridical CSF';
        end
