...
suffixes = {'BartenCSF (FA + Beta)', 'BartenCSF_{HF} (FA + Beta)', 'castleCSF (FA + Beta)', 'castleCSF (FA + R power 3.4)', ...
            'castleCSF (FA + R power 3.5)', 'castleCSF (FA + R power 3.6)', 'castleCSF (FA + R power 3.7)', 'castleCSF (FA + E power 2.95)', ...
            'castleCSF (FA + E power 3)', 'castleCSF (FA + E power 3.05)', 'castleCSF (FA + E2 power 3.2)', 'castleCSF (FA + E2 power 3.3)', ...
            'castleCSF (FA + E2 power 3.4)', 'castleCSF (FA + E2 power 3.5)', 'castleCSF (FA + E2 power 3.6)', 'castleCSF (FA + E2 power 3.7)'};
...
Energy_Model_cell = {@(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_fixarea_beta(Barten_Original_model,fit_poly_degree, radius, area_value, vrr_f_value, luminance_value), ...
                     ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.6), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.7), ...
                     ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.05), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.3), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.4), ...
                     ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.7), ...
                     };
CSF_Model_cell = {Barten_Original_model, Barten_HF_model, castleCSF_model, castleCSF_model, ...
...
initial_E_thr_values(5) = 1.112189244284369e+05;
initial_E_thr_values(6) = 1.112189244284369e+05;
initial_E_thr_values(7) = 1.112189244284369e+05;

initial_E_thr_values(8) = 12059.56337;
initial_E_thr_values(9) = 12059.56337;
initial_E_thr_values(10) = 12059.56337;

initial_E_thr_values(11) = 137582.1334;
initial_E_thr_values(12) = 137582.1334;
initial_E_thr_values(13) = 137582.1334;
initial_E_thr_values(14) = 137582.1334;
initial_E_thr_values(15) = 137582.1334;
initial_E_thr_values(16) = 137582.1334;
...
if (optimize_need == 1)
    ...
    writematrix(optimized_E_thr_values, 'optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
    writematrix(fvals, 'fvals_x_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
else
    optimized_E_thr_values = readmatrix('optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
end
...
if (csv_generate_vrr_f == 1)
    ...
    writematrix(C_thr_results_x_vrr_f_range, 'C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
else
    C_thr_results_x_vrr_f_range_flat = readmatrix('C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
...
if (csv_generate_area == 1)
    ...
    writematrix(C_thr_results_x_area_range, 'C_thr_results_range_x_area_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
else
    C_thr_results_x_area_range_flat = readmatrix('C_thr_results_range_x_area_final_Quest_disk_C_t_energy_eachone_plot_6.csv');
...
if plot_vrr_f == 1
    figure;
    ha = tight_subplot(4, 4, [.07 .02],[.11 .03],[.035 .001]);
