...
for area_index = 1:length(area_contiuous)
    ...
    E_stelaCSF_all(area_index) = energy_model_spatial_fixarea_ecc_2(stelaCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_stelaCSF_HF_all(area_index) = energy_model_spatial_fixarea_ecc_2(stelaCSF_HF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_Barten_Original_all(area_index) = energy_model_spatial_fixarea_ecc_2(Barten_Original_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_Barten_HF_all(area_index) = energy_model_spatial_fixarea_ecc_2(Barten_HF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_castleCSF_all(area_index) = energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_stelaCSF_transient_all(area_index) = energy_model_spatial_fixarea_ecc_2(stelaCSF_transient_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
    E_stelaCSF_HF_transient_all(area_index) = energy_model_spatial_fixarea_ecc_2(stelaCSF_HF_transient_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, pow);
end
