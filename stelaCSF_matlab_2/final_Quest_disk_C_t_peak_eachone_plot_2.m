...
if (optimize_need == 1)
    ...
    writematrix(optimized_k_scale_values, 'optimized_k_scale_values_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
    writematrix(fvals, 'fvals_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
else
    optimized_k_scale_values = readmatrix('optimized_k_scale_values_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
end
...
if (csv_generate_vrr_f == 1)
    ...
    writematrix(C_thr_results_x_vrr_f_range, 'C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
else
    C_thr_results_x_vrr_f_range_flat = readmatrix('C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
...
if (csv_generate_area == 1)
    ...
    writematrix(C_thr_results_x_area_range, 'C_thr_results_range_x_area_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
else
    C_thr_results_x_area_range_flat = readmatrix('C_thr_results_range_x_area_final_Quest_disk_C_t_peak_eachone_plot_2.csv');
