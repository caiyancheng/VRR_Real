...
if (optimize_need == 1)
    ...
    optimized_E_thr_values = readmatrix('optimized_E_thr_values_x_size_1_beta.csv');
end
...
if (csv_generate == 1)
    for vrr_f_i = 1:length(vrr_f_indices)
        ...
        for size_range_i = 1:length(continuous_size_range)
            ...
            [~,~,~,CSF_results_range(11,vrr_f_i,size_range_i), CSF_results_range(12,vrr_f_i,size_range_i), CSF_results_range(13,vrr_f_i,size_range_i)] = ...
            ...
            [~,~,CSF_results_range(14,vrr_f_i,size_range_i), CSF_results_range(15,vrr_f_i,size_range_i)] = ...
    ...
    writematrix(continuous_area_range, 'continuous_area_range.csv');
else
    ...
    continuous_area_range = readmatrix('continuous_area_range.csv');
end
...
for vrr_f_i = 1:length(vrr_f_indices)-1
    ...
    scatter(x_axis, average_C_t_matrix(vrr_f_i, :), 50, 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k', 'LineWidth', 1.0);
    errorbar(x_axis, average_C_t_matrix(vrr_f_i, :), error_lower, error_upper, 'LineStyle', 'none', 'Color', 'k', 'LineWidth', 1.0);
    plot(x_axis_range, reshape(CSF_results_range(11,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.4, 0.9, 0.1], 'MarkerSize', 3);
    plot(x_axis_range, reshape(CSF_results_range(12,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.9, 0.2, 0.9], 'MarkerSize', 3);
    plot(x_axis_range, reshape(CSF_results_range(13,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.9, 0.9, 0.1], 'MarkerSize', 3);
    grid on;
    ...
    scatter(x_axis, average_C_t_matrix(vrr_f_i, :), 50, 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k', 'LineWidth', 1.0);
    errorbar(x_axis, average_C_t_matrix(vrr_f_i, :), error_lower, error_upper, 'LineStyle', 'none', 'Color', 'k', 'LineWidth', 1.0);
    plot(x_axis_range, reshape(CSF_results_range(14,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.1, 0.9, 0.9], 'MarkerSize', 3);
    plot(x_axis_range, reshape(CSF_results_range(15,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.6, 0.2, 0.7], 'MarkerSize', 3);
    grid on;
end
...
scatter(x_axis, average_C_t_matrix(vrr_f_i, :), 50, 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k', 'LineWidth', 1.0, 'DisplayName', 'Subjective Result');
errorbar(x_axis, average_C_t_matrix(vrr_f_i, :), error_lower, error_upper, 'LineStyle', 'none', 'Color', 'k', 'LineWidth', 1.0, 'DisplayName', 'Psychometric function fitting error bar');
plot(x_axis_range, reshape(CSF_results_range(11,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.4, 0.9, 0.1], 'MarkerSize', 3, 'DisplayName', suffixes{11});
plot(x_axis_range, reshape(CSF_results_range(12,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.9, 0.2, 0.9], 'MarkerSize', 3, 'DisplayName', suffixes{12});
plot(x_axis_range, reshape(CSF_results_range(13,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.9, 0.9, 0.1], 'MarkerSize', 3, 'DisplayName', suffixes{13});
grid on;
hLegend = legend('show','FontSize',9);
set(hLegend, 'Location', 'southoutside', 'Orientation', 'vertical'); 
legendPos = get(hLegend, 'Position');
...
scatter(x_axis, average_C_t_matrix(vrr_f_i, :), 50, 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k', 'LineWidth', 1.0, 'DisplayName', 'Subjective Result');
errorbar(x_axis, average_C_t_matrix(vrr_f_i, :), error_lower, error_upper, 'LineStyle', 'none', 'Color', 'k', 'LineWidth', 1.0, 'DisplayName', 'Psychometric function fitting error bar');
plot(x_axis_range, reshape(CSF_results_range(14,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.1, 0.9, 0.9], 'MarkerSize', 3, 'DisplayName', suffixes{14});
plot(x_axis_range, reshape(CSF_results_range(15,vrr_f_i, :), 1, []), '-o', 'LineWidth', 1, 'Color', [0.6, 0.2, 0.7], 'MarkerSize', 3, 'DisplayName', suffixes{15});
grid on;
hLegend = legend('show','FontSize',9);
set(hLegend, 'Location', 'southoutside', 'Orientation', 'vertical'); 
legendPos = get(hLegend, 'Position');
