...
suffixes = {'BartenCSF (FA + Beta)', 'BartenCSF_{HF} (FA + Beta)', 'castleCSF (FA + Beta)', 'stelaCSF (FA + SI power 0.05)', ...
            'castleCSF (FA + R power 2)', 'castleCSF (FA + R power 2.2)', 'castleCSF (FA + R power 2.4)', 'castleCSF (FA + R power 2.6)', ...
            'castleCSF (FA + R power 2.8)', 'castleCSF (FA + R power 3.0)', 'castleCSF (FA + R power 3.2)', 'castleCSF (FA + R power 3.4)', ...
            'castleCSF (FA + E power 2.2)', 'castleCSF (FA + E power 2.4)', 'castleCSF (FA + E power 2.6)', 'castleCSF (FA + E power 2.8)', ...
            'castleCSF (FA + E power 3)', 'castleCSF (FA + E power 3.2)','castleCSF (FA + E2 power 2)', 'castleCSF (FA + E2 power 2.5)', ...
            'castleCSF (FA + E2 power 3)', 'castleCSF (FA + E2 power 3.5)', 'castleCSF (FA + E2 power 4)', 'castleCSF (FA + E2 power 4.5)'};
...
Energy_Model_cell = {@(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_fixarea_beta(Barten_Original_model,fit_poly_degree, radius, area_value, vrr_f_value, luminance_value), ...
                     ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea(stelaCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 0.05), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.4), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.6), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.8), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.0), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_radius(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.4), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.4), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.6), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.8), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.0), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 2.5), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.0), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 3.5), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 4.0), ...
                     @(csf_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value) energy_model_spatial_fixarea_ecc_2(castleCSF_model, fit_poly_degree, radius, area_value, vrr_f_value, luminance_value, 4.5), ...
                     };
CSF_Model_cell = {Barten_Original_model, Barten_HF_model, castleCSF_model, stelaCSF_model, ...
                  castleCSF_model, castleCSF_model, castleCSF_model, castleCSF_model, ...
                  castleCSF_model, castleCSF_model, castleCSF_model, castleCSF_model, ...
                  castleCSF_model, castleCSF_model, castleCSF_model, castleCSF_model, ...
                  castleCSF_model, castleCSF_model, castleCSF_model, castleCSF_model, ...
                  castleCSF_model, castleCSF_model, castleCSF_model, castleCSF_model};
...
if (optimize_need == 1)
    if length(skip_optimize_list) > 0
        optimized_E_thr_values_csv = readmatrix('optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
        optimized_fvals_csv = readmatrix('fvals_x_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
    end
    ...
    writematrix(optimized_E_thr_values, 'optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
    writematrix(fvals, 'fvals_x_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
else
    optimized_E_thr_values = readmatrix('optimized_E_thr_values_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
end
...
if (csv_generate_vrr_f == 1)
    ...
    writematrix(C_thr_results_x_vrr_f_range, 'C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
else
    C_thr_results_x_vrr_f_range_flat = readmatrix('C_thr_results_range_x_vrr_f_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
...
if (csv_generate_area == 1)
    ...
    writematrix(C_thr_results_x_area_range, 'C_thr_results_range_x_area_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
else
    C_thr_results_x_area_range_flat = readmatrix('C_thr_results_range_x_area_final_Quest_disk_C_t_energy_eachone_plot_5.csv');
...
if plot_vrr_f == 1
    figure;
    ha = tight_subplot(6, 4, [.07 .02],[.11 .03],[.035 .001]);
