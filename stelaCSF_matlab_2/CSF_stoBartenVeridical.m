classdef CSF_stoBartenVeridical < CSF_base

    % Original implementation of the spatiotemporal Barten CSF derived from his Ph.D. thesis (1999)
    
    
    methods
        
        function obj = CSF_stoBartenVeridical( )
        ...
        function name = short_name( obj )
            ...
            name = 'stoBarten-Veridical';
        end
        
        function name = full_name( obj )
            name = 'original Barten''s spatiotemporal veridical CSF';
        end
