...
csf_pars = struct('s_frequency', 1, 't_frequency', vrr_f_contiuous', 'orientation', 0, 'luminance', luminance_value, 'area', area_value, 'eccentricity', 0);
...
ylabel('Sensitivity');
title('Spatital Frequency 1 cpd, luminance 5 nits')
legend('show');
