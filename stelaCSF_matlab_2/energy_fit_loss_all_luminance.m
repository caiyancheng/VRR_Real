function loss_sum = energy_fit_loss_all_luminance(csf_model, energy_model, size_indices, vrr_f_indices, average_L_t_matrix, E_thr_value, fit_poly_degree, Luminance_lb, Luminance_ub)
    ...
    for size_i = 1:length(size_indices)
        ...
        for vrr_f_i = 1:length(vrr_f_indices)
            ...
            loss = (log10(average_L_t_matrix(vrr_f_i,size_i))-log10(L_thr_predict_results_energy_fit(vrr_f_i,size_i)))^2;
            if (isnan(loss))
                printf('NAN!')
