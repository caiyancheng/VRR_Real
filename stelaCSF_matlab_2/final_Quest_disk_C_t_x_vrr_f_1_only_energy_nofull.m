...
if (optimize_need == 1)
    ...
    writematrix(optimized_E_thr_values, 'optimized_E_thr_values_x_vrr_f_1_nofull.csv');
    writematrix(fvals, 'fvals_x_vrr_f_1_nofull.csv');
else
    optimized_E_thr_values = readmatrix('optimized_E_thr_values_x_vrr_f_1_nofull.csv');
end
...
if (csv_generate == 1)
    ...
    writematrix(CSF_results_range, 'CSF_results_range_x_vrr_f_1.csv');
else
    CSF_results_range_flat = readmatrix('CSF_results_range_x_vrr_f_1.csv');
