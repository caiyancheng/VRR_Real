...
save_json_10_path = 'plt_save_fig/MTime_2023-11-01/RefreshRate_[60,120,60]_Time_[2, 0.2, 0.2, 0.2, 0.2]_Color_[1.0,1.0,1.0]_Withblack.json'
save_json_08_path = 'plt_save_fig/MTime_2023-11-01/RefreshRate_[60,120,60]_Time_[2, 0.2, 0.2, 0.2, 0.2]_Color_[0.8,0.8,0.8]_Withblack.json'
save_json_06_path = 'plt_save_fig/MTime_2023-11-01/RefreshRate_[60,120,60]_Time_[2, 0.2, 0.2, 0.2, 0.2]_Color_[0.6,0.6,0.6]_Withblack.json'
save_json_04_path = 'plt_save_fig/MTime_2023-11-01/RefreshRate_[60,120,60]_Time_[2, 0.2, 0.2, 0.2, 0.2]_Color_[0.4,0.4,0.4]_Withblack.json'
save_json_02_path = 'plt_save_fig/MTime_2023-11-01/RefreshRate_[60,120,60]_Time_[2, 0.2, 0.2, 0.2, 0.2]_Color_[0.2,0.2,0.2]_Withblack.json'
...
x_10_real_begin = x_time_array_10_r[np.argmax(y_luminance_array_10 > max(y_luminance_array_10)/4*3)]
x_08_real_begin = x_time_array_08_r[np.argmax(y_luminance_array_08 > max(y_luminance_array_08)/4*3)]
x_06_real_begin = x_time_array_06_r[np.argmax(y_luminance_array_06 > max(y_luminance_array_06)/4*3)]
x_04_real_begin = x_time_array_04_r[np.argmax(y_luminance_array_04 > max(y_luminance_array_04)/4*3)]
x_02_real_begin = x_time_array_02_r[np.argmax(y_luminance_array_02 > max(y_luminance_array_02)/4*3)]
# plt.figure()
# plt.subplot(5,1,1)
