...
root_path = r'E:\Datasets\Temporal_Flicker_Meter_log\deltaL_L_10s\2023-12-19-20-43-10'
with open(os.path.join(root_path, 'config.json'), 'r') as fp:
    config_data = json.load(fp)
with open(r'E:\Py_codes\VRR_Real\dL_L\Temporal_Results/dl_L_results_10s_5r.json', 'r') as fp:
