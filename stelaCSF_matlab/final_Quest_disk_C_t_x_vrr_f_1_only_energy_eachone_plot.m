...
num_points = 1000;
beta = 3.5;
continuous_vrr_f_range = logspace(log10(0.25), log10(10), 30)';
fit_poly_degree = 4;
area_fix = 1;
Luminance_lb = 0.05;
Luminance_ub = 8;
...
for plot_i = 1:length(suffixes)
    ...
    legend_model_plots{end+1} = plot(continuous_vrr_f_range, CSF_results_range(plot_i,:,size_i), '-', 'LineWidth', 1, 'Color', color(size_i), 'DisplayName', display_name_model);
