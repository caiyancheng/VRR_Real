function [L_thr_barten_mod, C_t_barten_mod] = final_1cpd_barten_mod(t_frequency, area_value, radius, k_scale, fit_poly_degree, Luminance_lb, Luminance_ub)
    initial_L_thr = 3;
    options = optimset('Display', 'off');
    fun_barten_mod = @(L_thr) abs(get_contrast_from_Luminance(L_thr, fit_poly_degree, radius) - 1 / (k_scale*S_barten_mod(1, L_thr, area_value, t_frequency)));
