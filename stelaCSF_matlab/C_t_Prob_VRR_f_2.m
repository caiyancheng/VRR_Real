...
for size_value = size_indices
    for luminance_value = luminance_indices
        ...
        plot(vrr_f_CSF_list, C_t_stelaCSF, 'r-', 'LineWidth', 1.5, 'DisplayName', 'stelaCSF (1 cpd)');
        plot(vrr_f_CSF_list, C_t_stelaCSF_mod, 'g-', 'LineWidth', 1.5, 'DisplayName', 'stelaCSF_{mod} (1 cpd)');
        plot(vrr_f_CSF_list, C_t_barten_mod, 'c-', 'LineWidth', 1.5, 'DisplayName', 'Barten_{mod} (1 cpd)');
        hold off;
