function [L_thr_stela, L_thr_stela_mod, L_thr_barten_mod, C_t_stela, C_t_stela_mod, C_t_barten_mod] = final_contrast_energy_model(t_frequency, area_value, radius, E_thr, fit_poly_degree, Luminance_lb, Luminance_ub) 
