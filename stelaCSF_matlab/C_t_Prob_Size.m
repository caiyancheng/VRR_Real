...
for luminance_value = luminance_indices 
    for vrr_f_value = vrr_f_indices
        ...
        csf_pars = struct('s_frequency', 1, 't_frequency', vrr_f_value, 'orientation', 0, 'luminance', luminance_value, 'area', size_CSF_list, 'eccentricity', 0);
        ...
        plot(size_CSF_list, C_t_CSF, 'r-', 'LineWidth', 1.5, 'DisplayName', 'stelaCSF (1 cpd)');
        hold off;
        % xlabel('Size (Degree)');
        % ylabel('C_t (Average across Observers)');
