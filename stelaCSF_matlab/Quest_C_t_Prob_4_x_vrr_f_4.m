...
c_t_subjective_path = 'B:\Py_codes\VRR_Real\VRR_subjective_Quest\Result_Quest_disk_3\Observer_Ali_2/reorder_result_D_thr_C_t.csv';
...
group_num = 6;
figure;
ha = tight_subplot(length(size_indices), group_num, [.04 .02],[.2 .1],[.05 .05]);
