function [result_stela, result_stela_mod, result_barten_mod] = multiple_contrast_energy_detectors_cyc_2(L_b, c, beta, num_points, t_frequency, size_value) 
...
function value = S_stela(rho, L_b, size_value, t_frequency)
    ...
    csf_pars = struct('s_frequency', rho, 't_frequency', t_frequency, 'orientation', 0, 'luminance', L_b, 'area', size_value*size_value, 'eccentricity', 0);
